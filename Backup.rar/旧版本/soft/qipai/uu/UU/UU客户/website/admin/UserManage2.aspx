<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManage2.aspx.cs" Inherits="EUGameSite.Admin.UserManage2" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0"  style="width:800px">
            <tr>
                <td class="Manage_Header">
                    <asp:Label ID="普通玩家信息" Text="机器人玩家信息" runat="server" />
                </td>
            </tr>
            <tr>
