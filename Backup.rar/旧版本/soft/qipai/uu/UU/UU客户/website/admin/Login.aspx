<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EUGameSite.Admin.Login" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .login4{background-image: url(mages/login_4.jpg); width:960px; height:91px; margin:0 auto;}
    ...
    <tr>
        ...
        <td>
            <asp:Button ID="BtnLogin" runat="server" Text="登录管理"  
                ...
                style="height: 21px"/>
            &nbsp;<input id="BtnHome" type="button" value="返回首页" onclick='location.href="../index.aspx"' /></td>
    </tr>
   </table>
    </div>
