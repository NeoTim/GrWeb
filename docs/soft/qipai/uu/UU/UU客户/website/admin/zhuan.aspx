<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhuan.aspx.cs" Inherits="EUGameSite.Admin.zhuan" %>
...
<body>
    <form  id="form1" runat="server">
     <div class="div_All">
    <div class="Body_Title">财务管理 》》玩家转账管理</div>
        <hr />
        <div >
       </div>
    </div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style=" width:800px">
            <tr>
                <td class="Manage_Header">
                    <asp:Label ID="玩家转账记录" Text="玩家转账记录" runat="server" />
                </td>
            </tr>
            <tr>
                ...
                <table><tr><td>筛选条件：</td><td>
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="27px" 
                        Width="124px">
                       <asp:ListItem>转账ID</asp:ListItem>
                    <asp:ListItem>对方ID</asp:ListItem>
                    </asp:DropDownList></td><td style="height: 20px; width:20px;"></td><td>
