<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ques_Editor.aspx.cs" Inherits="EUGameSite.Admin.Ques_Editor" %>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="300" class="Manage_Table">
                <tr>
                    <td colspan="2" class="Manage_Header">
                        <asp:Label ID="lblAction" runat="server"></asp:Label>常见问题</td>
                </tr>
