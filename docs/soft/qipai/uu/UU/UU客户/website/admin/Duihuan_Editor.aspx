<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Duihuan_Editor.aspx.cs" Inherits="GameWeb.admin.Duihuan_Editor" %>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="300" class="Manage_Table">
                <tr>
                    <td colspan="2" class="Manage_Header">
                        <asp:Label ID="lblAction" runat="server"></asp:Label>兑换信息</td>
                </tr>
